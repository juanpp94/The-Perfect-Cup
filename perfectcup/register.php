          ...
          $("#register").click(function(){
              ...
              $.ajax({
                  ...
                  success: function(html){
                      if(html == "true"){
                          $("#add-err2").html('<div class="alert alert-success">\
                                               <strong>Account</strong> processed.\ \
                                               </div>');
                          window.location.href = "index.php";
                      }
                      else if (html == 'false'){
                        $("#add_err2").html('<div class-="alert laert-danger"> \
                        ...
                        $("#add_err2").html('<div class-="alert laert-danger"> \
                                              <strong>Error</strong> procesing request. Please try again \ \
                                             </div>');
                      }
                    },
                    beforeSend: function(){   
